...
interface ZKSmartHealthCardsInterface extends ethers.utils.Interface {
  functions: {
    ...
    "immunizations(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "immunizations",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export class ZKSmartHealthCards extends BaseContract {
  ...
  interface: ZKSmartHealthCardsInterface;
